...
- [x] (2026-06-25 01:04Z) Ran final review lanes. Code/schema found no issues; docs/release and benchmark lanes found three docs/process notes, all fixed in `0e49e70`, and a follow-up control pass found no substantive issues.
- [x] (2026-06-25 01:08Z) Pushed `rc/2.0.0` and opened PR #44 to `main`: https://github.com/kleverhq/wavepeek/pull/44.
