...
if [ -n "${WAVEPEEK_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v2.1.0"
elif [ -n "${WAVEPEEK_INSTALLER_GITHUB_BASE_URL:-}" ]; then
    INSTALLER_BASE_URL="$WAVEPEEK_INSTALLER_GITHUB_BASE_URL"
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v2.1.0"
else
    ARTIFACT_DOWNLOAD_URLS="https://github.com/kleverhq/wavepeek/releases/download/v2.1.0"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.32.0"},"source":{"app_name":"wavepeek","name":"wavepeek","owner":"kleverhq","release_type":"github"},"version":"2.1.0"}
EORECEIPT
...
The installer for wavepeek 2.1.0

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/kleverhq/wavepeek/releases/download/v2.1.0
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "wavepeek-aarch64-apple-darwin.tar.gz")
            ...
            _checksum_value="b3b88050e165a36514d3bb53bfdb3c059bd97cdfc56990281b19d5902355016b"
            _bins="wavepeek"
        ...
        "wavepeek-aarch64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="3b4ae0ccd40cb1cee29e0842588bef4dc52a7b40a06e55db3a59185a4c70de6b"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-apple-darwin.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="8c8a4d873f17b6eb59f4e558fe05729e16687d30cfe2f6de7e73ff1340935fc4"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="09e759b4dfe3c7543807b6b8ffbcd6feb73de3fab0df1b39211b1db65e99258d"
            _bins="wavepeek.exe"
        ...
        "wavepeek-x86_64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="e9b8c77e396b8feb40a381ca19898ec68fbb97e4da59dfaff960750a3845db07"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
