...
- `compare.py` compares two capture directories and, when same-format median timing is the only failure with no functional mismatches, missing/invalid artifacts, or timeout warnings, runs best-sample confirmation for the failed tests.
