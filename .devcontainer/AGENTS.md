...
- OpenCode is intentionally not installed or mounted in the devcontainer; do not restore its image install, state mounts, or VS Code extension recommendation.
