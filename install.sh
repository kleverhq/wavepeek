...
if [ -n "${WAVEPEEK_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v1.0.1"
elif [ -n "${WAVEPEEK_INSTALLER_GITHUB_BASE_URL:-}" ]; then
    INSTALLER_BASE_URL="$WAVEPEEK_INSTALLER_GITHUB_BASE_URL"
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v1.0.1"
else
    ARTIFACT_DOWNLOAD_URLS="https://github.com/kleverhq/wavepeek/releases/download/v1.0.1"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.32.0"},"source":{"app_name":"wavepeek","name":"wavepeek","owner":"kleverhq","release_type":"github"},"version":"1.0.1"}
EORECEIPT
...
The installer for wavepeek 1.0.1

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/kleverhq/wavepeek/releases/download/v1.0.1
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "wavepeek-aarch64-apple-darwin.tar.gz")
            ...
            _checksum_value="d5f9c4e1e0d34b785edc0c126bbab4f7cb22002163263cd5af72edcd4558c43e"
            _bins="wavepeek"
        ...
        "wavepeek-aarch64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="2e0901eceac7e0fa89022be0eb6aa947b8acde3746d31b6680600df20097024c"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-apple-darwin.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="3a1df220cda956d7bb4c12234326d1355634e355a701ab319cb547ce70c9530d"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="52a6d65db03977d87081b1eceecdf867e59f363f189c8e267a46105ad9477077"
            _bins="wavepeek.exe"
        ...
        "wavepeek-x86_64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="5a36da049f1057ce249eb93f9ad387662fc49e5576e46a7907f73e8d28da682c"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
