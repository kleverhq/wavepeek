...
if [ -n "${WAVEPEEK_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v2.0.0"
elif [ -n "${WAVEPEEK_INSTALLER_GITHUB_BASE_URL:-}" ]; then
    INSTALLER_BASE_URL="$WAVEPEEK_INSTALLER_GITHUB_BASE_URL"
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/kleverhq/wavepeek/releases/download/v2.0.0"
else
    ARTIFACT_DOWNLOAD_URLS="https://github.com/kleverhq/wavepeek/releases/download/v2.0.0"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.32.0"},"source":{"app_name":"wavepeek","name":"wavepeek","owner":"kleverhq","release_type":"github"},"version":"2.0.0"}
EORECEIPT
...
The installer for wavepeek 2.0.0

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/kleverhq/wavepeek/releases/download/v2.0.0
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "wavepeek-aarch64-apple-darwin.tar.gz")
            ...
            _checksum_value="ff80ed73ffce96872b678ffa5d93e641b1b585c38faa9ba0aedf7ea2305f96d1"
            _bins="wavepeek"
        ...
        "wavepeek-aarch64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="c3112bbf43106b87d532ab06992ca85a648072b3524d8bf1a65990b34aa7bd73"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-apple-darwin.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="69b15f16003766f4f9751982aea912b1582ef561772dade9cf37511c88dcb5ba"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
        ...
        "wavepeek-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="8a125ac7f967e9ef2a3a1f23ea67b86279d19ebf462cfa46dcae3b33b62f71d4"
            _bins="wavepeek.exe"
        ...
        "wavepeek-x86_64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="10bc52b6b99480becfd8030f1e52be2d01d9a90094155191685885cb1cbc4262"
            _bins="wavepeek"
            _bins_js_array='"wavepeek"'
            _libs=""
            _libs_js_array=""
