...
5. **Stable machine contracts.** JSON output is versioned through an explicit schema `$schema` URL such as `schema-output-v2.2.json`, while human-readable output stays intentionally more flexible.
