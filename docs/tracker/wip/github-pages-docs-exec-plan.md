...
- [ ] Milestone 5 is next: expose docs-site workflows through `just`, add helper tests to `test-aux`, and wire docs-site checks into `just check` and `just ci`.
