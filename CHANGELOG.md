...
### Added
- Added `fsdb_demo/`, a standalone Verdi/FsdbReader lazy-loading probe that can be copied to a licensed host to validate the FSDB bridge feasibility hypothesis.
