...
{"$schema":"https://kleverhq.github.io/wavepeek/wavepeek_v1.json","command":"value","data":{"time":"10ns","signals":[{"path":"top.clk","value":"1'h1"},{"path":"top.data","value":"8'h0f"}]},"diagnostics":[]}
```
